...
use Drupal\group_flex\Annotation\GroupJoiningMethod;

/**
 * Provides the Group joining method plugin manager.
 */
class GroupJoiningMethodManager extends DefaultPluginManager {

  /**
   * Constructs a new GroupJoiningMethodManager object.
   *
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/GroupJoiningMethod', $namespaces, $module_handler, GroupJoiningMethodInterface::class, GroupJoiningMethod::class);

    $this->alterInfo('group_flex_group_joining_method_info');
    $this->setCacheBackend($cache_backend, 'group_flex_group_joining_method_plugins');
  }
