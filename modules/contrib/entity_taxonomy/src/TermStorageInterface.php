...
/**
 * Defines an interface for entity_taxonomy_term entity storage classes.
 */
interface TermStorageInterface extends ContentEntityStorageInterface {
   ...
   *   automatically cleared when deleting a entity_taxonomy term.
   ...
   *   automatically updates when when a entity_taxonomy term is added/updated.
   *   https://www.drupal.org/node/2785693
   */
   ...
   *   they are partial objects queried directly from the {entity_taxonomy_term_data}
   *   table to save execution time and memory consumption when listing large
   *   numbers of terms. Defaults to FALSE.
   *
   * @return object[]|\Drupal\entity_taxonomy\TermInterface[]
