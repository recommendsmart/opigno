...
class VocabularyResetForm extends EntityConfirmFormBase {
  ...
  public function getFormId() {
    return 'entity_taxonomy_vocabulary_confirm_reset_alphabetical';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('entity_taxonomy')->notice('Reset vocabulary %name to alphabetical order.', ['%name' => $this->entity->label()]);
