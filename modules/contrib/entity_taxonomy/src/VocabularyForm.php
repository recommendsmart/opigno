  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    if ($this->moduleHandler->moduleExists('language')) {
      ...
      $form['default_terms_language']['default_language'] = [
        ...
        '#entity_information' => [
          'entity_type' => 'entity_taxonomy_term',
          'bundle' => $vocabulary->id(),
        ],
        '#default_value' => ContentLanguageSettings::loadByEntityTypeBundle('entity_taxonomy_term', $vocabulary->id()),
      ];
    }
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        ...
        $this->logger('entity_taxonomy')->notice('Created new vocabulary %name.', ['%name' => $vocabulary->label(), 'link' => $edit_link]);
      ...
      case SAVED_UPDATED:
        ...
        $this->logger('entity_taxonomy')->notice('Updated vocabulary %name.', ['%name' => $vocabulary->label(), 'link' => $edit_link]);
