...
namespace Drupal\entity_taxonomy\Plugin\views\argument_validator;
 ...
 *   id = "entity_taxonomy_term_name",
 *   title = @Translation("entity_taxonomy term name"),
...
class TermName extends Entity {
  ...
  /**
   * The entity_taxonomy term storage.
   *
