 ...
 */
class EntityTaxonomyTermHierarchyConstraintValidator extends ConstraintValidator implements ContainerInjectionInterface {
  ...
  /**
   * Creates a new entity_taxonomyTermHierarchyConstraintValidator instance.
   *
