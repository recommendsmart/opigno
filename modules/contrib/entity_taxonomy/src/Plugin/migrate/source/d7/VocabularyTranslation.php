 ...
 *
 * @MigrateSource(
 *   id = "d7_entity_taxonomy_vocabulary_translation",
...
class VocabularyTranslation extends Vocabulary {
  ...
  public function query() {
    ...
    if ($this->getDatabase()
      ->schema()
      ->fieldExists('entity_taxonomy_vocabulary', 'language')) {
  ...
  public function fields() {
    $fields = [
      ...
      'v_language' => $this->t('Language from the entity_taxonomy_vocabulary table.'),
