...
/**
 * Provides Drupal 7 entity_taxonomy term entity translation source plugin.
 *
 * @MigrateSource(
 *   id = "d7_entity_taxonomy_term_entity_translation",
...
class TermEntityTranslation extends FieldableEntity {
  ...
  public function query() {
    $query = $this->select('entity_translation', 'et')
      ...
      ->condition('et.entity_type', 'entity_taxonomy_term')
      ->condition('et.source', '', '<>');

    $query->innerJoin('entity_taxonomy_term_data', 'td', 'td.tid = et.entity_id');
    $query->innerJoin('entity_taxonomy_vocabulary', 'tv', 'td.vid = tv.vid');
