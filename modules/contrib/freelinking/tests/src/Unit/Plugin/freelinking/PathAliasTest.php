...
class PathAliasTest extends UnitTestCase {
  ...
  protected function setUp() {
    ...
    $aliasManagerProphet = $this->prophesize('\Drupal\path_alias\AliasManagerInterface');
    ...
    $this->container->set('path_alias.manager', $aliasManagerProphet->reveal());
  ...
  public function testDefaultConfiguration() {
    $plugin = $this->getPlugin();
    $this->assertEquals(['settings' => ['failover' => 'search']], $plugin->defaultConfiguration());
  }
