...
/**
 * Returns targets of access records that are of a certain entity type.
 *
 * @ingroup views_relationship_handlers
 *
 * @ViewsRelationship("access_record_target")
 */
class AccessRecordTarget extends RelationshipPluginBase {
  ...
  public function query() {
    ...
    $entity_type_id = $this->definition['target_type'];
    ...
    $type_ids = $type_storage
      ...
      ->condition('target_type', $entity_type_id)
      ->execute();
    ...
    $data_query->join($query, 'id', "[id].[target_id] = [data].[${id_key}]");
