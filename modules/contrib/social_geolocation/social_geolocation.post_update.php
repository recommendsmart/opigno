 ...
 */
function social_geolocation_post_update_8002_enable_search_submodule(): void {
 ...
 */
function social_geolocation_post_update_8003_remove_geocoder_configuration(): void {
  $bundles = [
    ['group', 'open_group'],
    ['group', 'closed_group'],
    ['group', 'public_group'],
  ...
  $field_ids = array_map(
    static fn($e) => "{e[0]}.{e[1]}.field_{e[0]}_geolocation",
    $bundles
  );
