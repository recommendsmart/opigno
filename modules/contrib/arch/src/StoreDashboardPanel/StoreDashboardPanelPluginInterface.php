...
/**
 * Defines the required interface for all panel plugins.
 *
 * @todo Add detailed documentation here explaining the panel system's
 ...
 *   interface.
 */
interface StoreDashboardPanelPluginInterface extends ConfigurableInterface, DependentPluginInterface, PluginFormInterface, PluginInspectionInterface, CacheableDependencyInterface, DerivativeInspectionInterface {
   ...
   *
   * @see \Drupal\arch\BlockAccessControlHandler
   */
