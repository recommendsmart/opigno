...
namespace Drupal\arch_product\Plugin\views\argument_default;
 ...
 *   id = "product",
 *   title = @Translation("Product ID from URL", context = "arch_product")
 * )
 */
class Product extends ArgumentDefaultPluginBase implements CacheableDependencyInterface {
  ...
  public function getArgument() {
    if (
      ($product = $this->routeMatch->getParameter('product'))
