...
namespace Drupal\commerceg_product\Controller;
...
/**
 * Returns responses for `commerceg_product` GroupContent routes.
 */
class Product extends GroupContentController {
