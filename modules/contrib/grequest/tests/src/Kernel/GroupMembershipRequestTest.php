...
class GroupMembershipRequestTest extends GroupKernelTestBase {
  ...
  public function testRequestStatusUpdate() {
    ...
    $this->assertEqual($group_membership_request->grequest_status->value, GroupMembershipRequest::REQUEST_NEW);
    $group_membership_request->delete();

    $group_membership_request = $this->membershipRequestManager->create($this->group, $account);
    $this->membershipRequestManager->saveRequest($group_membership_request);
