 ...
 * @group eca_content
 */
class TokenLoadEntityRefTest extends KernelTestBase {
  ...
  /**
   * Tests TokenLoadEntityRef.
   */
  public function testTokenLoadEntityRef() {
  ...
  // Create an action that that loads the referenced entity.
    ...
    /** @var \Drupal\eca_content\Plugin\Action\TokenLoadEntity $action */
