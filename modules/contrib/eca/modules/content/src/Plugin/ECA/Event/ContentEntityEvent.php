...
class ContentEntityEvent extends EventBase {
  ...
  public static function actions(): array {
    return [
      'bundlecreate' => [
        ...
        'drupal_id' => ContentEntityEvents::BUNDLECREATE,
        'drupal_event_class' => ContentEntityBundleCreate::class,
        'tags' => Tag::CONFIG | Tag::WRITE | Tag::PERSISTENT | Tag::AFTER,
      ],
      'bundledelete' => [
        'label' => 'Delete content entity bundle',
        'drupal_id' => ContentEntityEvents::BUNDLEDELETE,
        'drupal_event_class' => ContentEntityBundleDelete::class,
        'tags' => Tag::CONFIG | Tag::WRITE | Tag::PERSISTENT | Tag::AFTER,
      ],
      'create' => [
        'label' => 'Create content entity',
        'drupal_id' => ContentEntityEvents::CREATE,
        'drupal_event_class' => ContentEntityCreate::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::RUNTIME | Tag::AFTER,
      ],
      'revisioncreate' => [
        'label' => 'Create content entity revision',
        'drupal_id' => ContentEntityEvents::REVISIONCREATE,
        'drupal_event_class' => ContentEntityRevisionCreate::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::RUNTIME | Tag::AFTER,
      ],
      'preload' => [
        'label' => 'Preload content entity',
        'drupal_id' => ContentEntityEvents::PRELOAD,
        'drupal_event_class' => ContentEntityPreLoad::class,
        'tags' => Tag::READ | Tag::BEFORE,
      ],
      'load' => [
        'label' => 'Load content entity',
        'drupal_id' => ContentEntityEvents::LOAD,
        'drupal_event_class' => ContentEntityLoad::class,
        'tags' => Tag::CONTENT | Tag::READ | Tag::AFTER,
      ],
      'storageload' => [
        'label' => 'Load content entity from storage',
        'drupal_id' => ContentEntityEvents::STORAGELOAD,
        'drupal_event_class' => ContentEntityStorageLoad::class,
        'tags' => Tag::CONTENT | Tag::READ | Tag::PERSISTENT | Tag::AFTER,
      ],
      'presave' => [
        'label' => 'Presave content entity',
        'drupal_id' => ContentEntityEvents::PRESAVE,
        'drupal_event_class' => ContentEntityPreSave::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::PERSISTENT | Tag::BEFORE,
      ],
      'insert' => [
        'label' => 'Insert content entity',
        'drupal_id' => ContentEntityEvents::INSERT,
        'drupal_event_class' => ContentEntityInsert::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::PERSISTENT | Tag::AFTER,
      ],
      'update' => [
        'label' => 'Update content entity',
        'drupal_id' => ContentEntityEvents::UPDATE,
        'drupal_event_class' => ContentEntityUpdate::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::PERSISTENT | Tag::AFTER,
      ],
      'translationcreate' => [
        'label' => 'Create content entity translation',
        'drupal_id' => ContentEntityEvents::TRANSLATIONCREATE,
        'drupal_event_class' => ContentEntityTranslationCreate::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::RUNTIME | Tag::AFTER,
      ],
      'translationinsert' => [
        'label' => 'Insert content entity translation',
        'drupal_id' => ContentEntityEvents::TRANSLATIONINSERT,
        'drupal_event_class' => ContentEntityTranslationInsert::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::PERSISTENT | Tag::AFTER,
      ],
      'translationdelete' => [
        'label' => 'Delete content entity translation',
        'drupal_id' => ContentEntityEvents::TRANSLATIONDELETE,
        'drupal_event_class' => ContentEntityTranslationDelete::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::PERSISTENT | Tag::AFTER,
      ],
      'predelete' => [
        'label' => 'Predelete content entity',
        'drupal_id' => ContentEntityEvents::PREDELETE,
        'drupal_event_class' => ContentEntityPreDelete::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::PERSISTENT | Tag::BEFORE,
      ],
      'delete' => [
        'label' => 'Delete content entity',
        'drupal_id' => ContentEntityEvents::DELETE,
        'drupal_event_class' => ContentEntityDelete::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::PERSISTENT | Tag::AFTER,
      ],
      'revisiondelete' => [
        'label' => 'Delete content entity revision',
        'drupal_id' => ContentEntityEvents::REVISIONDELETE,
        'drupal_event_class' => ContentEntityRevisionDelete::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::PERSISTENT | Tag::AFTER,
      ],
      'view' => [
        'label' => 'View content entity',
        'drupal_id' => ContentEntityEvents::VIEW,
        'drupal_event_class' => ContentEntityView::class,
        'tags' => Tag::CONTENT | Tag::RUNTIME | Tag::VIEW | Tag::BEFORE,
      ],
      'prepareview' => [
        'label' => 'Prepare content entity view',
        'drupal_id' => ContentEntityEvents::PREPAREVIEW,
        'drupal_event_class' => ContentEntityPrepareView::class,
        'tags' => Tag::CONTENT | Tag::RUNTIME | Tag::VIEW | Tag::BEFORE,
      ],
      'prepareform' => [
        'label' => 'Prepare content entity form',
        'drupal_id' => ContentEntityEvents::PREPAREFORM,
        'drupal_event_class' => ContentEntityPrepareForm::class,
        'tags' => Tag::CONTENT | Tag::RUNTIME | Tag::VIEW | Tag::BEFORE,
      ],
      'fieldvaluesinit' => [
        'label' => 'Init content entity field values',
        'drupal_id' => ContentEntityEvents::FIELDVALUESINIT,
        'drupal_event_class' => ContentEntityFieldValuesInit::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::RUNTIME | Tag::AFTER,
      ],
      'custom' => [
        'label' => 'ECA content entity custom event',
        'drupal_id' => ContentEntityEvents::CUSTOM,
        'drupal_event_class' => ContentEntityCustomEvent::class,
        'tags' => Tag::CONTENT | Tag::WRITE | Tag::RUNTIME | Tag::AFTER,
      ],
    ];
  }
  ...
  public function fields(): array {
    if ($this->drupalEventClass() === ContentEntityCustomEvent::class) {
