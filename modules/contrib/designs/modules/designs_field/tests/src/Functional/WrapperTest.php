...
class WrapperTest extends BrowserTestBase {
  ...
  public function testWrapper() {
    ...
    // Setup the wrapper.
    $parents = "fields[{$field_name}][settings_edit_form][third_party_settings][designs_field]";
    $this->drupalDesign(
      $parents,
    ...
    $this->assertSession()->pageTextContainsOnce(t('Wrapper Design: @label', ['@label' => 'Content']));
    ...
    $design = $display->getRenderer($this->field['field_name'])->getThirdPartySettings('designs_field');
    ...
    $this->assertTrue(in_array('label', $design['regions']['content']));
